  ...
  module Configuration
    module GrapeApi
      ...
      class ApiCallbackSet < Plugins::Configuration::Callbacks::CallbackSet
        ...
        CALLBACKS = ['model_klass', 'resource_identifier', 'resource_finder_key', 'query_scope', 'default_query_scope', 'query_includes', 'after_fetch_resource', 'should_paginate?', 'resource_params_attributes', 'new_resource', 'set_presenter', 'resource_actions', 'resources_actions'] + BLOCK_CALLBACKS
